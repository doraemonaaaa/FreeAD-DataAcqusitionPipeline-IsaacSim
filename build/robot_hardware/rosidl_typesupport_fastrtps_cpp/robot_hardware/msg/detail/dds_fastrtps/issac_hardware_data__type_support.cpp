...
#include "robot_hardware/msg/detail/issac_hardware_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_hardware::msg::IssacHardwareData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_hardware::msg::IssacHardwareData & ros_message)
{
  // Member: real_speed_l
  cdr >> ros_message.real_speed_l;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_robot_hardware
max_serialized_size_IssacHardwareData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_hardware::msg::IssacHardwareData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_hardware::msg::IssacHardwareData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_hardware::msg::IssacHardwareData *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _IssacHardwareData__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const robot_hardware::msg::IssacHardwareData *>(
...
static size_t _IssacHardwareData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_IssacHardwareData(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _IssacHardwareData__callbacks = {
  "robot_hardware::msg",
  "IssacHardwareData",
...
static rosidl_message_type_support_t _IssacHardwareData__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_IssacHardwareData__callbacks,
...
{
  return &robot_hardware::msg::typesupport_fastrtps_cpp::_IssacHardwareData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_hardware, msg, IssacHardwareData)() {
  return &robot_hardware::msg::typesupport_fastrtps_cpp::_IssacHardwareData__handle;
}
