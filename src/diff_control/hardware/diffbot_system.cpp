...
namespace diff_control
{
        ...
        const hardware_interface::HardwareInfo &info)
    {
        ...
        // 设置左右轮子的参数
        wheel_l_.setup(cfg_.left_wheel_name, cfg_.wheel_radius);
        wheel_r_.setup(cfg_.right_wheel_name, cfg_.wheel_radius);
        //issac_bridge_p_->setup(cfg_.wheel_radius);
    ...
    std::vector<hardware_interface::CommandInterface> DiffBotSystemHardware::export_command_interfaces()
    {
        ...
        command_interfaces.emplace_back(hardware_interface::CommandInterface(
            wheel_l_.name, hardware_interface::HW_IF_VELOCITY, &wheel_l_.ex_vel));

        command_interfaces.emplace_back(hardware_interface::CommandInterface(
            wheel_r_.name, hardware_interface::HW_IF_VELOCITY, &wheel_r_.ex_vel));
    ...
    {
        auto [vel_l, vel_r] = issac_bridge_p_->read_motor_vel();
        ...
        const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
    {
        // wheel_l_.ex_vel = -1;
        // wheel_r_.ex_vel = -1;
        issac_bridge_p_->set_motor_vel(wheel_l_.ex_vel, wheel_r_.ex_vel);
